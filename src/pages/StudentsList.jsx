...
const StudentsList = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const mentorRes = await fetch("https://coinsite.pythonanywhere.com/mentors/get-me/", { headers });
  ...
  const handleViewStudent = async (studentId) => {
    try {
      ...
      const res = await fetch("https://coinsite.pythonanywhere.com/students/test/result/", { headers });
